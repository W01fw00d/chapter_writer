...
writer.narrate('Pasternak hijo lanzó el librito sobre la mesa, sin obtener reacción alguna de su interlocutor más allá de la sorna y despreocupación.')
writer.narrate('Se encontraba en una improvisada sala de los subterráneos de Barcelona, la cual había sido creada a partir de uno de los largos túneles. Ante él, un hombre magreví armado descansaba sobre un taburete, matones armados cubriéndole derecha e izquierda.')
writer.addCharacter('magrevi', ['el magreví', 'el jefe', 'el traficante', 'el extranjero'])
writer.addDialog('magrevi', 'Papel. Uno no puede andar registrando ventas de codificadores de ADN en la nube: los bots de google te encontrarían en medio segundo.')
writer.narrate('Andreu golpeó la mesa con ambos brazos, ante lo cual los dos guardias hicieron ademán de empuñar sus pistolas. El magreví les detuvo con un gesto.')
...
writer.addDialog('magrevi', 'O por alguien que usaba su nombre. Ya sabes, no solemos pedir documento de identidad por aquí... en fin, ¿Hay algo más que podamos hacer por usted, señor heredero?')
...
writer.addDialog('magrevi', 'Vaya... parece que ha llegado el siguiente cliente: tendrá que pedir hora para otro día')
...
writer.addCharacter('claudia', ['Clàudia', 'la policia', 'la chica hidrocarburo', 'la sotinspectora'])
writer.addCharacter('viladrau', ['Viladrau', 'el inspector', 'el inspector Viladrau'])
writer.addDialog('viladrau', '¡¿Com que has enviat a la carísima IA d\'en Nikola Musk a que s\'infiltri a una guarida de traficants de codificadors?!')
...
writer.addDialog('claudia', 'Freeman es va oferir, inspector. I tenint en conte la perillositat de la missió, i que en Pasternak a mi ja me coneix, pareixia l\'opció més lògica')
writer.narrate('El inspector se disponía a continuar riñéndola, con la vena cada vez más inchada, cuando su móbil, que reposaba sobre el escritorio de Clàudia, comenzó a sonar. En la pantalla táctil podía verse el nombre "Nikola Musk".')
...
writer.addDialog('freeman', 'Buenas tardes, me han comentado que aquí puedo encontrar codificadores de... un momento, que es ese ruido')
writer.addDialog('magrevi', '¿Cómo? Yo no oigo nada...')
writer.addDialog('freeman', '¡Shhh...! Creo que viene de esa pared de la derecha...')
writer.addDialog('magrevi', '... Jim, haz el favor de ir a ver si hay alguna rata correteando por ahí...')
writer.addDialog('freeman', 'Ehm.. no, no, esa pared no. Me refería a la pared de mi derecha, no la vuestra... perdón')
writer.narrate('El traficante me miró irritado, pero entonces posó sus ojos sobre algo llamativo de dicha pared. Había una luz roja parpadeante. Y... ahora que todo el mundo había callado al fin... sí que se oía algo... algo así como un pitido intermitente...')
writer.narrate('El instinto le gritó a Pasternak hijo que corriera, y eso hizo, tras agarrar a la carrera sus dos tarjetas de créditos y el libro de cuentas. Se encontraba cerca de la puerta trasera, rezando porque no estuviera cerrada... cuando un fogonazo de luz y un terrible estruendo cubrieron toda la sala.')

writer.addIntermission('de nuevo bajo el bello cielo despejado de Barcelona')

writer.narrate('Úrsula sonrió para si. Sostenía aún el dispositivo de control remoto que acababa de detonar las bombas que había colocado aquella mañana en el túnel. Seguramente ni ése magreví conocía su verdadera identidad, pero no podía correr riesgos. Además, a veces hay que enterrar el pasado para seguir avanzando. Era un patrón que se repetía en su vida, y siempre le conducía a una situación mejor.')
...
writer.narrate('Nikola Musk miró el móbil que sostenía en su mano derecha con indiferencia. En los altavoces del aparato sonaba el buzón de voz. Parecía que el inspector andaba muy ocupado.')
writer.narrate('El magnate suspiró y dio un sorbo a su mojito. Desde la ventanilla del avión podía ver la sagrada familia: la primera vez que la veia terminada. Una maravilla, sin duda... aunque no parecía merecer tanta espera. Sacudió la cabeza: no lograba quitarse de encima esa preocupación por el bienestar de Jordan Freeman. Había perdido la señal de localizador, lo cual podía deberse a un fallo o... que se encontrara en algún lugar incomunicado.')
...
writer.addDialog('cardenales', '... joder... ¡Calla puto robot! No te cargues mi tapadera... aquí soy una matona más del magreví...')
writer.addDialog('freeman', '... ¿Cree que siguen vivos?')
writer.addDialog('cardenales', 'No sé... a ver, espera creo que estoy tocando un cuerpo... joder que oscuro está todo... ahh, mi cabeza... ¡Ah! Estoy tocando una cara... creo que es la del chaval del magreví, su sobrino-nieto o algo así... Abdal')
writer.addCharacter('abdal', ['Abdal', 'el enchufado', 'el magreví junior', 'el matón familiar'])
writer.addDialog('abdal', 'Ah... ¡Quita, zorra! No me toques... eh, donde estamos. No veo una mierda')
writer.addDialog('freeman', 'Al parecer algún tipo de explosión detonó en la sala y se derrumbó parte del muro...')
writer.addDialog('abdal', '¡No jodas! ¿Y mi tio-abuelo? Joder, a ver... ¿Habeis encontrado alguno el escritorio? En uno de los cajones tendría que haber linternas... el jefe siempre tenía alguna por si acaso')
...
writer.narrate('Un haz de luz se originó de repente y le dio a Freeman de lleno en la cara. Cuando se apartó, pudo ver a un joven magreví, uno de los guardias que había visto al lado del capo, sosteniéndola.')
...
writer.addDialog('cardenales', '¡Estoy ciega! Joder, no puede ser... no veo nada, hijos de puta no me vacileis, no hay luz ni ostias...')
...
writer.addDialog('magrevi', 'Ab...dal...')
writer.narrate('El joven corrió hacia la voz de su tio-abuelo, que surgía de debajo de unos escombros cercanos al escritorio. Tras apartarlos, Abdal comprobó con horror que su jefe y familiar había recibido un buen golpe en la cabeza, y se encontraba entre la vigilia y la inconsciencia.')
writer.addDialog('abdal', 'Tío... no te preocupes, te sacaré de aquí...')
writer.addDialog('andreu', '... ¡Eh...! ¿Me oís?')
writer.narrate('Todos se sobresaltaron al escuchar de voz del heredero Pasternak proveniendo de la pared derrumbada. Se miraron con caras de sorpresa y esperanzas renovadas, menos la ciega, claro está.')
writer.addDialog('abdal', 'Eh! ¡Sí, Pasternak, estamos aquí! ¡Ja, ja, ja, que suerte! Escucha, avanza por el tunel y llegarás a otra sala donde descansan los hombres de mi tio... diles lo que ha ocurrido...')
writer.addDialog('andreu', 'Ya me gustaría... pero estoy atrapado, se ha derrumbado una parte del muro y la puerta parece haberse atrancado... no... no me digas que tú también...')
...
writer.addDialog('abdal', 'Ya veo... entonces fuistes tú, negro')
writer.narrate('Con un rápido movimiento, el joven magreví desenfundó su arma y apuntó a Jordan a la cabeza. Freeman levantó los brazos en señal de rendición, pero su torso continuó erguido sobre su ombligo, como si sus abdominales fueran de puro hierro.')
...
writer.addDialog('andreu', 'Chicos... ¡Chicos! ¿No oleis como a gas?')
writer.addDialog('abdal', '¿Qué? No...')
writer.addDialog('cardenales', 'Yo no huelo nada raro... y tengo buen olfato para estas cosas')
writer.addDialog('andreu', 'Vale, pues... por favor, no provoqueis ninguna chispa... creo que se ha roto una tubería y mi sala se está llenando de gas...')
writer.addDialog('abdal', 'De puta madre...')
writer.narrate('Andreu no había tenido una vida fácil, a pesar de ser rico y esas cosas. Es más, había comprobado más de una vez aquello de que las cosas siempre pueden empeorar. Era el único patrón de su vida que sabía que nunca dejaría de repetirse. Aunque aquella vez la cosa había ido a otro nivel.')
